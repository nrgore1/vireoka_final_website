      ...
      try {
        if (!token) {
          setData({
            ...
            ctas: {
              primary: { label: "Request a new NDA link", href: "/intelligence/status" },
              secondary: { label: "Back to Investor Access", href: "/intelligence/access" },
            },
          });
          return;
        }
      ...
      <div style={boxStyle}>
        ...
        <div style={btnRow}>
          ...
          {!primary?.href && !secondary?.href && !loading && (
            <button style={secondaryBtn} onClick={() => go("/intelligence/access")}>
